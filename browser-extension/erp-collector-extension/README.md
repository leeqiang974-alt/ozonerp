...
这是 Chrome / Edge 浏览器扩展，用于统一处理 1688、拼多多货源采集和 Ozon 前台竞品采集任务，并发送到本地 ERP。
...
2. 在浏览器里登录 1688、拼多多和 Ozon。
3. 打开 1688 商品详情页，可点击「采集当前商品」手动入箱。
4. 打开拼多多商品详情页，可点击页面右下角的 PDD 采集浮层手动入箱。
5. 打开 Ozon 前台页面后，插件后台会领取 ERP 下发的 Ozon 搜索/详情采集任务。
6. 点击扩展里的「立即检查任务」可以手动唤醒后台 worker。
